...
export class SizeService {
     ...
     * @return OK
     */
    sizePost(sizeEntity: SizeEntity): Promise<SizeEntity> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processSizePost(_response);
        });
    }

    protected processSizePost(response: Response): Promise<SizeEntity> {
     ...
     * @return OK
     */
    sizePut(sizeEntity: SizeEntity): Promise<SizeEntity> {
        let url_ = this.baseUrl + "/api/size";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processSizePut(_response);
        });
    }

    protected processSizePut(response: Response): Promise<SizeEntity> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    sizeGet(id: number): Promise<SizeEntity> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processSizeGet(_response);
        });
    }

    protected processSizeGet(response: Response): Promise<SizeEntity> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    sizeDelete(id: number): Promise<boolean> {
        let url_ = this.baseUrl + "/api/size/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id)); 
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processSizeDelete(_response);
        });
    }

    protected processSizeDelete(response: Response): Promise<boolean> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
