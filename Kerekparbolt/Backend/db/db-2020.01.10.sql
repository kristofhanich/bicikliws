...
﻿DELIMITER $$
CREATE OR REPLACE PROCEDURE UserCreate(OUT paramId INT8, IN paramUniqID VARCHAR(128), IN paramEmail VARCHAR(255), IN paramJelszo VARCHAR(255), IN paramRole VARCHAR(32))
BEGIN
    INSERT INTO 
		  User
